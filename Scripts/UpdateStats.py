...
def createStatImage(df: pd.DataFrame, index: int):
    ...
    img = Image.open(f'/Users/evenlandmark/Desktop/tables/Scripts/Backgrounds/Stat_bg.png')
    size = img.size[1]
    ydab = size/13
    draw = ImageDraw.Draw(img)
    font = ImageFont.truetype("/Users/evenlandmark/Desktop/tables/Scripts/Fonts/Aller_Bd.ttf", 25)
    fontM = ImageFont.truetype("/Users/evenlandmark/Desktop/tables/Scripts/Fonts/Aller_Bd.ttf", 27)
    fontBig = ImageFont.truetype("/Users/evenlandmark/Desktop/tables/Scripts/Fonts/Aller_Bd.ttf", 30)
    ...
    for ind, row in df.iterrows():
        ...
        y = (i+2)*ydab - 53
        logo = Image.open("/Users/evenlandmark/Desktop/tables/Scripts/Logoer - Runde/" + teamname + ".png")
    ...
    img.save(f'/Users/evenlandmark/Desktop/tables/Scripts/Output/{season}/{statname}.png')
