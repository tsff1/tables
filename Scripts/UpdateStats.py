...
def createStatImage(df: pd.DataFrame, index: int):
    ...
    img = Image.open(f'C:/Users/alfha/OneDrive - NTNU/vår 26/tsff vs code/tables/Scripts/Backgrounds/Stat_bg.png')
    size = img.size[1]
    ydab = size/13
    draw = ImageDraw.Draw(img)
    font = ImageFont.truetype("C:/Users/alfha/OneDrive - NTNU/vår 26/tsff vs code/tables/Scripts/Fonts/Aller_Bd.ttf", 25)
    fontM = ImageFont.truetype("C:/Users/alfha/OneDrive - NTNU/vår 26/tsff vs code/tables/Scripts/Fonts/Aller_Bd.ttf", 27)
    fontBig = ImageFont.truetype("C:/Users/alfha/OneDrive - NTNU/vår 26/tsff vs code/tables/Scripts/Fonts/Aller_Bd.ttf", 30)
    ...
    for ind, row in df.iterrows():
        ...
        y = (i+2)*ydab - 53
        logo = Image.open("C:/Users/alfha/OneDrive - NTNU/vår 26/tsff vs code/tables/Scripts/Logoer - Runde/" + teamname + ".png")
    ...
    img.save(f'C:/Users/alfha/OneDrive - NTNU/vår 26/tsff vs code/tables/Scripts/Output/{season}/{statname}.png')
